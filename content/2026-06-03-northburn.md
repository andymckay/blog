...
In 2026 I decided to set myself the goal of doing a half marathon every month as a way to set a better base level of fitness. Sometimes it's a training run by myself or sometimes it's a race. In February I did the [First Half](/2026-02-23-first-half.html) and had some heart problems but set a personal record for that race. Since I was in New Zealand, I tried to find a race and ended up at the [Northburn](https://www.northburn100.co.nz/).
