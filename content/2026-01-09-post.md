...
* I was set for the whole holiday. That's it.

As they say "...supports 100% of features without an active Internet connection. Install Organic Maps, download maps, throw away your SIM card, and go for a weeklong trip on a single battery charge without any byte sent to the network"
...
Given the political climate in the US, *constantly sending your location to the US might be something you'd like to avoid.* 
