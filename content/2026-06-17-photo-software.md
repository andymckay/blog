...
However, when I started on this hobby I noticed that two names always came up as the default: <b>Photoshop</b> and <b>Lightroom</b>, both by Adobe. These peices of software are used by most of the photographers online, in blogs, youtube videos, and in the clubs I'm in. Both are from a US company and both require a monthly subscription.

I wanted to find an alternative to avoid sending my money to country that repeatedly threatens not only Canada, but [1 out of every 13 countries on the planet](https://www.cnn.com/2026/05/27/politics/oman-trump-threat-attack-countries).

<div class="alert alert-primary">ℹ️ This is not a list of good or bad companies, or any reflection on their software. This is just to clarify the nationality of the company so you can add that to your buying decisions.</div>

<div class="alert alert-primary">ℹ️ This list might not be perfect and it can be <a href="https://github.com/andymckay/blog">updated on GitHub</a>, or <a href="/about.html">drop me a line</a> and I'll try my best to keep up to date with corrections or additions.</div>

### <a id="companies">List of software</a>
